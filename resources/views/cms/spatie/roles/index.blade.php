    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$role->id}}</td>
          <td>{{$role->name}}</td>
          <td><a href="{{route('role.permission.index',$role->id)}}" class="btn btn-info">{{$role->permissions_count}} Permission/s</a></td>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                      ...
                      <a href="#" onclick="performDestroy({{$role->id}}, this)">Delete</a>
                    </a>
                  </div>
                </div>
              </td> --}}
