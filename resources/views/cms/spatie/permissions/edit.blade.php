      ...
      <div class="card-body">
        ...
        {{-- <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control guards" id="guards" style="width: 100%;">
                <option value="web"@if ($permissions->guard_name == 'web')
                    selected
                @endif>مستخدم</option>
                <option value="admin" @if ($permissions->guard_name == 'admin')
                    selected
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" id="name"class="form-control"placeholder="أدخل الاسم ..."aria-label="Name"aria-describedby="basic-addon-name"required value="{{$permissions->name}}"/>
          </div>
...
<script>
    ...
    function performUpdate(id){
        ...
        let redirectUrl = '/dashboard/permissions'
        update('/dashboard/permissions/'+id,data,redirectUrl);
    }
</script>
@endsection
