...
<div class="col-md-12 col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title"> اضافة عقود ايجار </h4>
      </div>
      <div class="card-body">
        ...
        {{-- <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" id="name"class="form-control"placeholder="أدخل اسم العقد..."aria-label="Name"aria-describedby="basic-addon-name"required/>
          </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="start_date" id="start_date"class="form-control" aria-label="Name"aria-describedby="basic-addon-name"required/>
          </div>
          <div class="form-group">
            <label class="form-label" for="end_date">تاريخ نهاية الحجز</label>
            <input type="date" name="end_date" id="end_date"class="form-control" aria-label="Name"aria-describedby="basic-addon-name"required/>
          </div>
