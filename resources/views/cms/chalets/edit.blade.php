...
<div class="col-md-12 col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title"> تعديل الشاليهات  </h4>
      </div>
      <div class="card-body">
        ...
        {{-- <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="type" id="type"class="form-control"placeholder="أدخل نوع الشاليه..."aria-label="Name"aria-describedby="basic-addon-name"required value="{{$chalets->type}}"/>
          </div>
          <div class="form-group">
      ...
      <div class="card-footer">
        <button type="button" onclick="performUpdate({{$chalets->id}})" class="btn btn-primary">تعديل</button>
    </div>
...
<script>
    ...
    function performUpdate(id){
        ...
        let redirectUrl = '/dashboard/chalet'
        update('/dashboard/chalet/'+id,data,redirectUrl);
    }
</script>
