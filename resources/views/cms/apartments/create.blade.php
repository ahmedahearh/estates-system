...
<div class="col-md-12 col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title"> اضافة شقق  </h4>
      </div>
      <div class="card-body">
        ...
        {{-- <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="which_floor" id="which_floor"class="form-control"placeholder="أدخل رقم الطابق..."aria-label="Name"aria-describedby="basic-addon-name"required/>
          </div>
          <div class="form-group">
...
<script>
    ...
    function performStore(){
        ...
        store('/dashboard/apartments/',data);
    }
</script>
